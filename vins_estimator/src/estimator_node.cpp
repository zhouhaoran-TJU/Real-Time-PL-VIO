...
void predict(const sensor_msgs::ImuConstPtr &imu_msg)
{
    ...
    double dx = RB*imu_msg->linear_acceleration.x;
    double dy = RB*imu_msg->linear_acceleration.y;
    double dz = RB*imu_msg->linear_acceleration.z;
...
void send_imu(const sensor_msgs::ImuConstPtr &imu_msg)
{
    ...
    double dz = RB*imu_msg->linear_acceleration.z - ba[2];
    double dy = RB*imu_msg->linear_acceleration.y - ba[1];
    double dx = RB*imu_msg->linear_acceleration.x - ba[0];
